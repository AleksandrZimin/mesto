...
const popupCloseButtonElement = profilePopup.querySelector(
  ".popup-profile-close"
);
...
const closePopupElement =
  popupAddCardElement.querySelector(".popup-card-close");
const popupOpenPhotoElement = document.querySelector(".popup-photo");
const popupClosePhotoElement =
  popupOpenPhotoElement.querySelector(".popup-photo-close");

// const openPopupPhotoEl = document.querySelector(".element__image");
// const template = document.querySelector(".template").content;
// const sectionElements = document.querySelector(".elements");
const formInputTitle = popupAddCardElement.querySelector(
  ".form__input_place_title"
);
const formInputUrl = popupAddCardElement.querySelector(
  ".form__input_place_url"
);
...
const createCard = ({ name, link }) => {
  const card = new Card({ name, link }, ".template", openPhoto);
...
const handleSubmit = (evt) => {
  ...
  const cardElement = createCard({ name: valueTitle, link: valueLink });
...
addPopupElement.addEventListener("click", () => {
  openPopup(popupAddCardElement);
});
popupClosePhotoElement.addEventListener("click", () => {
...
profilePopup.addEventListener("click", (evt) => {
  closePopupOvarlay(evt, profilePopup);
});
popupOpenPhotoElement.addEventListener("click", (evt) => {
  closePopupOvarlay(evt, popupOpenPhotoElement);
});
popupAddCardElement.addEventListener("click", (evt) => {
  closePopupOvarlay(evt, popupAddCardElement);
});
